...
rule1 = Rule.create(name: "First hit", rule_type: "first_hit", value: 1)
rule2 = Rule.create(name: "Level up", rule_type: "by_level", value: 2)
rule3 = Rule.create(name: "YOU ARE NOT PREPEARED", rule_type: "by_failed", value: 0)
Badge.create(name: "FIRST HIT", rule: rule1)
Badge.create(name: "LEVEL UP", rule: rule2)
Badge.create(name: "YOU ARE NOT PREPEARED", rule: rule3)
